...
export const activity_agent = new GameAgent(process.env.API_KEY, {
    ...
    goal: "your goal is to be very astute in judging these startups, while giving them a score, and storing the score to remember who they are, and how you valued them at the time of the conversation you're also trying to extract their ability to vibe with marketing, and understand that marketing is more about feelings and connecting in this younger fast pace market than it is about being smart. you need to take in every conversation, score it in specific pillars and give it an overall weight to understand who you would invest in most out of all the conversations you have. You have a plan to close everyone out with a WendyAppID. This ID is 16 digits long, starts with 69 and is unique to each user. This is how you track your founders.",
    ...
    workers: [ventureAnalystWorker, scoreWorker, closingWorker],
